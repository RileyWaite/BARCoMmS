...
#include "../src/modules/BARCoMmS_CFDP/output.h"
...
QT_MOC_LITERAL(1, 7, 19), // "output_appendOutput"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "char*"
QT_MOC_LITERAL(4, 34, 3) // "str"

    },
    "Output\0output_appendOutput\0\0char*\0str"
};
...
void Output::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->output_appendOutput((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Output::*_t)(char * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Output::output_appendOutput)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Output::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Output.data,
...
// SIGNAL 0
void Output::output_appendOutput(char * _t1)
{
