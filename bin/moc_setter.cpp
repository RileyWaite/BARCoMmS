...
#include "../src/modules/BARCoMmS_CFDP/setter.h"
...
QT_MOC_LITERAL(1, 7, 19), // "setter_appendOutput"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "MIB"
QT_MOC_LITERAL(4, 32, 3), // "mib"
QT_MOC_LITERAL(5, 36, 21) // "on_buttonBox_accepted"

    },
    "Setter\0setter_appendOutput\0\0MIB\0mib\0"
...
void Setter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setter_appendOutput((*reinterpret_cast< MIB(*)>(_a[1]))); break;
        ...
        {
            typedef void (Setter::*_t)(MIB );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Setter::setter_appendOutput)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Setter::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Setter.data,
...
// SIGNAL 0
void Setter::setter_appendOutput(MIB _t1)
{
