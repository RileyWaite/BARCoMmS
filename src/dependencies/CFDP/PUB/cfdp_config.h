...
/* FILE: cfdp_config.h.ground -- configuration of the CFDP library.
 * HELP:  This is intended to be the same as 'cfdp_config.h', except for:
 *   1) The default temp file is "temp" instead of "/tmp/temp"
 *   2) The default outgoing file chunk size is 250.
 *   3) The max file chunk size is 997.
 */
...
#define MAX_CONCURRENT_TRANSACTIONS 1000

/* The maximum number of file gaps that can be stored by each transaction */
#define MAX_GAPS_PER_TRANSACTION 5000
 ...
 */
#define MAX_FILE_CHUNK_SIZE 65200
 ...
 */
#define MAX_PDU_LENGTH (32 + MAX_FILE_CHUNK_SIZE)
 ...
 */
#define DEFAULT_TEMP_FILE_NAME_PREFIX "temp"
 ...
 */
#define MAX_TEMP_FILE_NAME_LENGTH 256
...
#define DEFAULT_ISSUE_EOF_RECV 1
...
#define DEFAULT_ISSUE_TRANSACTION_FINISHED 1
#define DEFAULT_MY_ID "23"
#define DEFAULT_RESPONSE_TO_FAULT RESPONSE_CANCEL

/* Default values for 'Remote Entity' parameters (timers) */
#define DEFAULT_ACK_LIMIT 25
#define DEFAULT_ACK_TIMEOUT 5
#define DEFAULT_INACTIVITY_TIMEOUT 86400
#define DEFAULT_NAK_LIMIT 25
 ...
 */
#define DEFAULT_OUTGOING_FILE_CHUNK_SIZE 65200
...
#define MSG_PDU_FILEDATA 0      /* input of Filedata PDUs */
#define MSG_PDU_NON_FILEDATA 1  /* input/output of all other PDUs */
#define MSG_PDU_RETRANSMITTED_FD 0  /* Outgoing retrans Filedata PDUs */
