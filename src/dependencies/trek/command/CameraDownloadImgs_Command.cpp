...
CameraDownloadImgs_Command::CameraDownloadImgs_Command()
{
   APID = 8;
}

bool
CameraDownloadImgs_Command::fromBytes(ByteBuffer& buf)
{
...
bool
CameraDownloadImgs_Command::toBytes(ByteBuffer& buf)
{
