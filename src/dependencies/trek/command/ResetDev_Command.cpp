...
ResetDev_Command::ResetDev_Command()
{
    APID = 17;
}

bool
ResetDev_Command::fromBytes(ByteBuffer& buf)
{
...
bool
ResetDev_Command::toBytes(ByteBuffer &buf)
{
