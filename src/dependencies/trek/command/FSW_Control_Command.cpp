...
FSW_Control_Command::FSW_Control_Command()
{
   APID = 1;
}

bool
FSW_Control_Command::fromBytes(ByteBuffer& buf)
{
...
bool
FSW_Control_Command::toBytes(ByteBuffer& buf)
{
