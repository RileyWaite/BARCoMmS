...
TransmitDataRate_Command::TransmitDataRate_Command()
{
    APID = 20;
}
...
bool
TransmitDataRate_Command::fromBytes(ByteBuffer& buf)
{
...
bool
TransmitDataRate_Command::toBytes(ByteBuffer& buf)
{
