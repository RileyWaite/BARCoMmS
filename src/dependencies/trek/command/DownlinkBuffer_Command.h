#ifndef DOWNLINKBUFFER_COMMAND_H
#define DOWNLINKBUFFER_COMMAND_H
 ...
 */
class DownlinkBuffer_Command : public AbstractCommandPDU
{
   public:
...
#endif  // DOWNLINKBUFFER_COMMAND_H
