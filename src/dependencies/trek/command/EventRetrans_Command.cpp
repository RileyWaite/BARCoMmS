...
EventRetrans_Command::EventRetrans_Command()
{
    APID = 21;
}

bool
EventRetrans_Command::fromBytes(ByteBuffer& buf)
{
...
bool
EventRetrans_Command::toBytes(ByteBuffer& buf)
{
