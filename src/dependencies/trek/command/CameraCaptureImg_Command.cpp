...
CameraCaptureImg_Command::CameraCaptureImg_Command()
{
    APID = 13;
}

bool
CameraCaptureImg_Command::fromBytes(ByteBuffer& buf)
{
   ...
   buf.getBits(160, 8, avgBrightness);
   buf.getBits(168, 8, fill);
...
bool
CameraCaptureImg_Command::toBytes(ByteBuffer& buf)
{
   ...
   buf.putBits(160, 8, avgBrightness);
   buf.putBits(168, 8, fill);
