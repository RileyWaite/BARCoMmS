#ifndef ABORTCOMMPASS_COMMAND_H
#define ABORTCOMMPASS_COMMAND_H
 ...
 */
class AbortCommPass_Command : public AbstractCommandPDU
{
public:

    // Command fields

    AbortCommPass_Command();
