...
CommSchedule_Command::CommSchedule_Command()
{
    APID = 4;
}

bool
CommSchedule_Command::fromBytes(ByteBuffer& buf)
{
    ...
    buf.getBits(160, 16, numSlots);
    buf.getBits(176, 32, startTime1);
    buf.getBits(208, 16, duration1);
    buf.getBits(224, 16, dataRate1);
    buf.getBits(240, 32, startTime2);
    buf.getBits(272, 16, duration2);
    buf.getBits(288, 16, dataRate2);

    return true;
}

bool
CommSchedule_Command::toBytes(ByteBuffer &buf)
{
    ...
    buf.putBits(160, 16, numSlots);
    buf.putBits(176, 32, startTime1);
    buf.putBits(208, 16, duration1);
    buf.putBits(224, 16, dataRate1);
    buf.putBits(240, 32, startTime2);
    buf.putBits(272, 16, duration2);
    buf.putBits(288, 16, dataRate2);
