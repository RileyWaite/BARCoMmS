...
TelemQuery_Command::TelemQuery_Command()
{
   APID = 5;
}

bool
TelemQuery_Command::fromBytes(ByteBuffer& buf)
{
   ...
   buf.getBits(160, 8, pdu);
   buf.getBits(168, 8, queryType);
   buf.getBits(176, 32, start);
   buf.getBits(208, 32, end);
...
bool
TelemQuery_Command::toBytes(ByteBuffer& buf)
{
   ...
   buf.putBits(160, 8, pdu);
   buf.putBits(168, 8, queryType);
   buf.putBits(176, 32, start);
   buf.putBits(208, 32, end);
