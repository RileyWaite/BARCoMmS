...
/*=r=*************************************************************************/
boolean cfdp_enable_message_class (int message_class)
{
  /*------------------------------------------------------------*/
  return (message_class__enable (message_class));
}



/*=r=*************************************************************************/
boolean cfdp_disable_message_class (int message_class)
{
  /*------------------------------------------------------------*/
  return (message_class__disable (message_class));
}



/*=r=*************************************************************************/
boolean cfdp_is_message_class_enabled (int message_class)
{
  /*------------------------------------------------------------*/
  return (message_class__enabled (message_class));
}
